...
const Admin = () => {
  ...
  return (
    <Container maxWidth="lg" className="admin-container" sx={{ marginTop: 2 }}>
      <Box className="admin-content">
        {/* Header com botão de voltar */}
        <Box className="admin-header" sx={{ marginBottom: 4 }}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <StyledCard>
              <CardContent sx={{ flexGrow: 1, textAlign: 'center', padding: 3 }}>
                <PeopleIcon sx={{ fontSize: 60, color: '#1976d2', marginBottom: 2 }} />
          ...
          <Grid item xs={12} sm={6} md={4}>
            <StyledCard>
              <CardContent sx={{ flexGrow: 1, textAlign: 'center', padding: 3 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Visualize e gerencie todos os agendamentos, confirme ou cancele serviços.
                </Typography>
              </CardContent>
              <Box sx={{ padding: 3, paddingTop: 0 }}>
                <Button 
